...
<div class="tarif-grid">
  <div class="tarif-card">
    <p class="tarif-card__profil">Mineurs et étudiants (-30 ans)</p>
    <p class="tarif-card__lieu">Neuilly ou autre</p>
...
<div class="tarif-grid">
  ...
  <div class="tarif-card">
    <p class="tarif-card__profil">Mineurs, étudiants (-30 ans), recherche d'emploi et minimas sociaux</p>
    <p class="tarif-card__lieu">Autres communes</p>
    <div class="tarif-card__lignes">
...
Cas donnant droit à une réduction de cotisation annuelle :

- 1ère inscription au CNF d'une personne ayant déjà pratiqué l'aviron dans un club en France ou à l'étranger
...
Cas donnant droit à un remboursement partiel de l'inscription :
...
<div class="actions">
  ...
  <a class="actions__secondaire" href="/espace-adherents/renouveler-son-adhesion2">Renouveler mon inscription</a>
  <a class="actions__secondaire" href="/pratiquer/stages-decouverte">S'inscrire au stage découverte</a>
</div>
